...
<div class="image-container">
    <img src="horia.jpeg" alt="Horia" width="300" height="300">
</div>
...
<div class="education">
    <h2>Education:</h2>
    <div class="acs">
        <img src="ACS.png" alt="ACS" width="70" height="70">
    ...
    <div class="uvt">
        <img src="FMI.png" alt="UVT" width="70" height="70">
...
<div class="experience">
    <h2>Experience:</h2>
    <div class="backrest">
        <img src="backrest.jpeg" alt="Back&Rest" width="100" height="100">
        <h4>
            Back&Rest
        </h4>
        <h4>CEO</h4>
        <h6>MARCH 2024 - PRESENT</h6>
        <p>
            Self-Employed developing websites for small businesses.
        </p>
    </div>
    <div class="siemens">
        <img src="siemens.png" alt="Siemens-Energy" width="150" height="50">
...
Automated data management procedures.
...
Provided technical support and discussed stakeholder requirements.
    ...
    <div class="conti">
        <img src="conti.png" alt="Continental" width="200" height="100">
